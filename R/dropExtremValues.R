...
#' 
#' If present, values outside of absoluteMin and absoluteMax are dropped first. Afterwards values are dropped, that
#' are more than 2x of the standard deviation away from the mean value.
#' 
#' @param absolute_min The absolute minimum value which might still be okay. Lower values are dropped
#' @param absolute_max The absolute maximum value which might still be okay. Higher values are dropped
#' @export 
#' 
