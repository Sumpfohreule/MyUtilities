...
#' @param default Value to return in case \code{x} contains only NAs
#' (default is NA)
#' @return Either the minimum value of the vector or the provided default value
#' @seealso \code{\link{max_with_default}, \link{mean_with_default},
#' \link{sum_with_default}}
#' @export
#'
...
#' @seealso \code{\link{min_with_default}, \link{mean_with_default},
#' \link{sum_with_default}}
#' @export
#'
...
#' @seealso \code{\link{min_with_default}, \link{max_with_default},
#' \link{sum_with_default}}
#' @export
#'
...
#'
#' This function has been implemented mostly so it can be used like the min, max
#'  mean versions as 0 is already returned by sum as default
#' @param x value vector to apply sum() to
#' @param default Value to return in case \code{x} contains only NAs
#' (default is NA)
#' @return Either the sum value of the vector or the provided default value
#' @seealso \code{\link{min_with_default}, \link{max_with_default},
#' \link{mean_with_default}}
#' @export
#'
