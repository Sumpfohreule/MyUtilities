...
#'
#' The interval between all neighboring vector values is calculated and the
#' most frequent one returned.
#' Can be used to find the actual logging interval between dates if there are
#' gaps in the vector
#'
#' @param vector A vector of values which must be convertible to numeric
#' (dates, date-times, etc.)
#' @export
#'
