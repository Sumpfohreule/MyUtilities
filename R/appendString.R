...
#'
#' @param source.string The source value to which to append to. If it is NA or
#' empty sep will be ignored.
#' @param append.string The string which is to be appended to the source. If
#' source is empty only this string is returned
