...
#'
#' Depending on the paramters, the first and last POSIXct are added to a POSIXct vector.
#' The interval, which is important for the last date of a year can be provided (default: calculated from the vector)
#'
#' @param dates A POSIXct vector
#' @param interval The interval between to POSIXct values in seconds
#' @param add.start Flag if year start should be added. A date can be provided instead of the years beginning
#' @param add.end Flag if year start should be added. A date can be provided instead of the years ending
#' @export
#'
